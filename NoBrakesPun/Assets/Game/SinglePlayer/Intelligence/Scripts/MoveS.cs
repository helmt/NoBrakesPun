...
public class MoveS : MonoBehaviour
{
    ...
    public void FindNextNode()
    {
        try
        {
            //Node currentNode = GameObject.Find(current.ToString()).GetComponent<Node>();
            ...
            //objectivePosition = GameObject.Find(objective.ToString()).transform.position;
        }
        catch (Exception)
        {
            active = false;
    ...
    {
        active = true;
        nodes = graph.GetComponentsInChildren<Node>();
        FindNextNode();
    }
    ...
    void FixedUpdate()
    {
        ...
        {
            // Move to objective
            currentPosition = GameObjectPosition(this);
